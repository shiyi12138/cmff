...
<body>
  <div style="float: left">
      <div id="show" style="width: 700px;height: 300px; overflow-y:auto; border: 1px solid burlywood"></div>
      <textarea id="aaa" name="content" style="width:700px;height:300px;">
    </textarea>
